...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Factura.fecha_cambio'
        db.add_column(u'ventas_factura', 'fecha_cambio',
                      self.gf('django.db.models.fields.DateField')(default=None),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Factura.fecha_cambio'
        db.delete_column(u'ventas_factura', 'fecha_cambio')
    ...
    models = {
        ...
        u'ventas.factura': {
            ...
            'fecha_cambio': ('django.db.models.fields.DateField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
